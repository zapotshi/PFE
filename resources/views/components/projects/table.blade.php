          ...
          <tr>
            ...
            <td>
              @can('view', $project->client)
                <a href="{{ route('clients.show', $project->client) }}" class="text-decoration-none">{{ $project->client->name }}</a>
              @else
            ...
            <td>
              @isset($project->manager)
                @can('view', $project->manager)
                  <a href="{{ route('users.show', $project->manager) }}" class="text-decoration-none">{{ $project->manager->name }}</a>
                @else
